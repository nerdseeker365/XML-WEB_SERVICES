 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://service.weather.com", wsdlLocation = "file:/C:/NIT/New-Webservices/workspace/JAX-WS-RI-Provider-CFA-WeatherWeb/WebContent/WEB-INF/WeatherWeb.wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://service.weather.com", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/NIT/New-Webservices/workspace/JAX-WS-RI-Provider-CFA-WeatherWeb/WebContent/WEB-INF/WeatherWeb.wsdl");
     ...
     */
    @WebEndpoint(name = "WeatherServiceImpl")
    public WeatherServiceImpl getWeatherServiceImpl() {
        return super.getPort(new QName("http://service.weather.com", "WeatherServiceImpl"), WeatherServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherServiceImpl")
    public WeatherServiceImpl getWeatherServiceImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.weather.com", "WeatherServiceImpl"), WeatherServiceImpl.class, features);
    }
